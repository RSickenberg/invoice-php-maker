...
Personal CLI tool: generates a PDF invoice (with a Swiss QR-bill) by answering interactive questions (client, tasks billed by category, hours, rate, payment term).
...
<!-- Keep this in sync with composer.json scripts, don't duplicate logic here. -->
